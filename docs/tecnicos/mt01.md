...
```
Y le doy click en Enter. Con esto ya tengo creada mi carpeta local que lleva el nombre de "eduard-flores".
...
![](../images/MT01/CLONE6.png)

Ya con los datos actualizados, ingreso el siguiente comando para abrir Visual Studio Code ya con el archivo "eduard-flores".

```bash
code .
```

![](../images/MT01/CLONE7.png)
